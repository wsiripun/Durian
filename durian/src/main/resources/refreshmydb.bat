DROP DATABASE IF EXISTS db_durian;
CREATE DATABASE db_durian;
USE db_durian;
...
insert into DurianTypes(typeName, typeDescription) values ('typeA', 'typeA Description');
insert into DurianTypes(typeName, typeDescription) values ('typeB', 'typeB Description');
insert into DurianTypes(typeName, typeDescription) values ('typeC', 'typeC Description');
insert into DurianTypes(typeName, typeDescription) values ('typeD', 'typeD Description');
